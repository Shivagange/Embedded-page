...
String Token="";
	...
	public  String gen() throws RemoteException, ServiceException {
		...
		AdministrationServiceService ts = new AdministrationServiceServiceLocator("localhost", 8081,
...
<div class="mymargintop">
  <h4>Yellowfin Embedded Demo</h4>

<div align="center" name="piechart" id="piechart">

<%
if(src.length()<50 || token.length()<5){
	src="<script type=\"text/javascript\" src=\"http://localhost:8081/JsAPI?reportUUID=5b052e68-2165-4541-91f0-f5a5b9b27e1f&yfFilter9fa000fb-fff5-458b-82fd-bec2b38c05cf="+user+"&token="+token+"\"></script>";
	out.print(src);
	}else{
